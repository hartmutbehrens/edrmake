...
void print_help(op_map &operators, string_map &franchises, string_vector &record_types, std::string &date, int edr_num, bool use_blank, std::string em_num, std::string sbid, int test_interval);
